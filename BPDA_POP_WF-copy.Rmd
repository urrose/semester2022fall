  ...
  tryCatch(	
    { 	
      ...
      df <- get_pums(variables = variable_list,	
                     ...
                     variables_filter = list(POBP = 372, CIT=4:5),	
...
# library(xlsx)
summary_df[,4:dim(summary_df)[2]] <- sapply(summary_df[,4:dim(summary_df)[2]],as.numeric)
write_xlsx(summary_df, "/Users/roselv/Desktop/675/2015_uruguay_pop.xlsx")
```
